...
myfunc(vec1, vec2)
# o bind agrupa os dados,
#c=coluna ou r para linha antes dele é o que indica o que agrupa
...
#(escola[LINHA,c(VetorParametros)], 1 para linha, 2 para coluna, mean=media)


# Exercicio 4 - Crie uma lista com 3 elementos, todos numéricos 
# e calcule a soma de todos os elementos da lista
lst <- list(a = 1:10, b = 1:5, c = 1:6)
lst
do.call(sum, lst) # sum= soma
#?do.call


# Exercicio 5 - Transforme a lista anterior um vetor
unlist(lst) #transforma lista em vetor
...
#FUNÇÃO(LOCAL=NOME, eixos(x=eixo, y=eixo)) + estilo de gráfico()
...
# o besinde, faz os dados serem individuais, e não um sobre o outro.
# o TRUE válida a função
